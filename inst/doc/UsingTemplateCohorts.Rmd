...
Here we create a cohort that searches for all drug exposures based on string patterns in the concept vocabulary
table.
...
bulk generate thousands of cohorts in a time that would be infeasible if using Circe standard cohorts from ATLAS or
Capr.
